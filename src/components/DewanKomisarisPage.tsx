...
interface DewanKomisarisPageProps {
  onBack: () => void;
}

const DewanKomisarisPage: React.FC<DewanKomisarisPageProps> = ({ onBack }) => {
  ...
  const tableData = [
    {
      id: '3',
      no: '3',
      penjelasanKriteria: 'DEWAN KOMISARIS/DEWAN PENGAWAS',
      bobot: '9',
      skor: '48.75',
      children: [
        {
          id: '3.1',
          no: '3.1',
          penjelasanKriteria: 'Komposisi dan kualifikasi Dewan Komisaris sesuai ketentuan',
          bobot: '2.5',
        ...
        },
        {
          id: '3.2',
          no: '3.2',
          penjelasanKriteria: 'Pelaksanaan rapat Dewan Komisaris secara berkala',
          bobot: '2.0',
        ...
        },
        {
          id: '3.3',
          no: '3.3',
          penjelasanKriteria: 'Fungsi pengawasan terhadap kinerja Direksi',
          bobot: '2.5',
          ...
          aspek: '0.83',
          capai: '33.33',
          sumberDokumen: 'Laporan Pengawasan',
          sumDok: 'Evaluasi Kinerja',
          pemenuhanDok: 'Tidak Ada',
          pemDok: 'Tidak Ada',
          rekomendasi: 'Buat sistem pengawasan',
        ...
        },
        {
          id: '3.4',
          no: '3.4',
          penjelasanKriteria: 'Pembentukan komite-komite pendukung',
          bobot: '2.0',
          unsurPemenuhan: { sub: '2', total: '3' },
          parameter: '1.33',
          indikator: '1.33',
          aspek: '1.33',
          capai: '66.67',
          sumberDokumen: 'SK Komite',
          sumDok: 'Charter Komite',
          pemenuhanDok: 'Ada',
          pemDok: 'Parsial',
          rekomendasi: 'Lengkapi komite',
          pemenuhanDok2022: 'Ada',
          keterangan: 'Perlu penambahan'
        }
      ]
    }
  ];
...
export default DewanKomisarisPage;